...
exports.defaultProducts = [
    {
        ...
        description: "A lightweight daily serum that brightens skin tone, evens complexion, and delivers deep, lasting hydration. Formulated with Niacinamide, Green Tea, and Hyaluronic Acid for visibly clearer, more radiant skin.",
        benefits: [
    ...
    },
    {
        ...
        description: "A targeted renewal treatment powered by Azelaic Acid and Licorice Root that fades post-acne marks and refines skin texture, helping skin look calmer and more even over time.",
        benefits: [
    ...
    },
    {
        ...
        description: "A correcting serum with Alpha Arbutin, Kojic Acid, and Licorice Extract to support smoother, firmer-looking skin and a more even tone as part of a nightly routine.",
        benefits: [
    ...
    },
    {
        ...
        description: "A rich daily face cream that locks in moisture and supports overnight skin renewal, leaving skin soft, plump, and glowing by morning.",
    ...
    },
    {
        ...
        description: "A targeted cream formulated to visibly reduce the appearance of hyperpigmentation and dark spots, for a brighter, more balanced complexion.",
        benefits: [
    ...
    },
    {
        ...
        description: "A nourishing face oil blend of Squalane, Argan Oil, and Chia that strengthens the skin barrier and locks in hydration for a healthy, dewy glow.",
    ...
    },
    {
        ...
        description: "A gentle daily foaming cleanser with Salicylic Acid, Lactic Acid, and Licorice Root Extract that clears pores of excess oil and impurities without stripping the skin.",
    ...
    },
    {
        ...
        description: "A traditional black soap deep-cleanse bar with our Purifying Herbal Complex that purifies skin and helps calm irritation, leaving skin feeling clean and balanced.",
    ...
    },
    {
        ...
        description: "A refreshing toner with our Skin Clarifying Complex that restores optimal skin pH, refines the look of pores, and preps skin to better absorb the treatments that follow.",
    ...
    },
    {
        ...
        description: "A brightening body scrub with Kojic Acid, Lemon Extract, and Vitamin E that gently exfoliates dead skin, smooths rough texture, and reveals a more even tone.",
    ...
    },
    {
        ...
        description: "A daily body wash with Kojic Acid, Licorice Root Extract, and Kaolin Clay that gently draws out impurities while keeping skin soft, clean, and balanced.",
    ...
    },
    {
        ...
        description: "A repairing daily body lotion with Tranexamic Acid, Alpha-Arbutin, Vitamin C, and Niacinamide that helps even skin tone and restore radiance from neck to toe.",
    ...
    },
    {
        ...
        description: "A fast-absorbing dry body oil blended with Argan Oil, Sweet Almond Oil, and Licorice for a luminous, non-greasy glow from head to toe.",
    ...
    },
    {
        ...
        description: "A rich, whipped body butter that melts into skin for deep, lasting nourishment — leaving skin soft, supple, and glowing from head to toe.",
    ...
    },
    {
        ...
        description: "A gentle, creamy daily cleanser that lifts away dirt and makeup while soothing and calming the skin, leaving it clean without feeling stripped.",
    ...
    },
    {
        ...
        description: "A pure, cooling aloe vera gel that soothes and hydrates skin, ideal for calming irritation and locking in moisture after sun or daily wear.",
    ...
    },
    {
        ...
        description: "A signature Naya Luxe fragrance — layered and complex, designed to linger. 50ml.",
    ...
    },
    {
        ...
        description: "A Naya Luxe fragrance built on warm amber wrapped in soft floral petals, for a rich and inviting finish. 50ml.",
        benefits: ["Long-lasting wear", "Signature Naya Luxe scent", "50ml glass bottle"],
    },
    {
        ...
        description: "A Naya Luxe fragrance pairing bright citrus top notes with a deep, mysterious base for day-to-night wear. 50ml.",
        benefits: ["Long-lasting wear", "Signature Naya Luxe scent", "50ml glass bottle"],
    },
    {
        ...
        description: "A Naya Luxe fragrance centered on rich oud, softened by velvety warmth for a bold, grounded finish. 50ml.",
        benefits: ["Long-lasting wear", "Signature Naya Luxe scent", "50ml glass bottle"],
    },
    {
        ...
        description: "A Naya Luxe fragrance built on clean, radiant musk with a soft, skin-like finish that wears close and light. 50ml.",
        benefits: ["Long-lasting wear", "Signature Naya Luxe scent", "50ml glass bottle"],
    },
];
